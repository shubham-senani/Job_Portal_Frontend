...
const ProfilePage = () => {
  return (
    ...
    >
      <Wrapper>
        <div
          className="d-flex justify-content-between head bg-light"
          style={{ width: "600px" }}
        >
          ...
          <button
            ...
            style={{ height: "30px" }}
          >
            <span className="fw-bold text-success">Edit</span>
          </button>
        </div>
        <div className="profile-header bg-light">
          <div className="detail">
            <div className="name">Skipper Senani</div>
            <div className="blue-strip tagline mt-1">Fashion Model</div>
          </div>
          <div className="overflow-hidden rounded profile-image">
            <img
        ...
        <div className="stat-container">
          <div className="stat left">
            <div className="big-text">247</div>
            <div className="small-text mt-3">TScore</div>
          </div>
          <div className="stat middle">
            <div className="big-text">4160</div>
            <div className="small-text mt-3">Credit</div>
          </div>
          <div className="stat right">
            <div className="big-text">Available</div>
            <div className="small-text mt-3">Status</div>
          </div>
        </div>
        <div
          className="d-flex flex-column px-5 py-2 bg-light rounded"
          style={{ width: "100%" }}
        >
          ...
          <div className="d-flex flex-row align-items-between mt-4">
            ...
            <div className="col-4 ms-5">8058135165</div>
          </div>
          <div className="d-flex flex-row align-items-between mt-4">
            <div
              className="col-3"
