...
import User_workdomain from "../components/user_registration _components/User_workdomain";
import RegistrationForm from "../components/user_registration _components/RegistrationForm";
import User_KYC from "../components/user_registration _components/User_KYC";
...
function getStepContent(step, addressFormProps, workdomainProps) {
  switch (step) {
    case 0:
      return <RegistrationForm data={addressFormProps} />;
    case 1:
      return <User_workdomain data={workdomainProps} />;
    case 2:
      return <User_KYC />;
    default:
...
export default function CreateJobPage() {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await authAxios.post("/api/v1/user", {
        fullName,
        fatherName,
        age,
        gender,
